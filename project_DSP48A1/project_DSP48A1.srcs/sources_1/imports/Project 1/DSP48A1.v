module DSP48A1 #(
    ...
    wire [17:0] A0_REG, A1_REG, B0_REG, B1_REG, D_REG, pre_add_sub, B_add_sub_mux;
    wire [47:0] C_REG;
    ...
    assign pre_add_sub = (OPMODE[6] == 1) ? (D_REG - B0_REG) : (D_REG + B0_REG);
    assign B_add_sub_mux = (OPMODE[4] == 1) ? pre_add_sub : B0_REG;
